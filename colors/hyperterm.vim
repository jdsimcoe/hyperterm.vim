" Vim Color File
" Name:       hyperterm.vim
" Maintainer: https://github.com/jdsimcoe/hyperterm.vim/
...
let g:colors_name="hyperterm"

" Set to "256" for 256-color terminals, or
" set to "16" to use your terminal emulator's native colors
" (a 16-color palette for this color scheme is available)
if !exists("g:hyperterm_termcolors")
  let g:hyperterm_termcolors = 256
endif
...
let s:red = { "gui": "#ff0000", "cterm": "196", "cterm16": "1" }
let s:dark_red = { "gui": "#ff0000", "cterm": "196", "cterm16": "9" }

let s:green = { "gui": "#33ff00", "cterm": "46", "cterm16": "2" } " Alternate cterm: 82

let s:yellow = { "gui": "#ffff00", "cterm": "226", "cterm16": "3" }
let s:dark_yellow = { "gui": "#ffff00", "cterm": "226", "cterm16": "11" }

let s:blue = { "gui": "#0066ff", "cterm": "21", "cterm16": "4" }

let s:purple = { "gui": "#cc00ff", "cterm": "165", "cterm16": "5" }

let s:cyan = { "gui": "#00ffff", "cterm": "51", "cterm16": "14" }

let s:white = { "gui": "#ffffff", "cterm": "15", "cterm16" : "15" }
...
let s:comment_grey = { "gui": "#808080", "cterm": "244", "cterm16": "8" }
let s:gutter_fg_grey = { "gui": "#808080", "cterm": "244", "cterm16": "15" }
let s:cursor_grey =  { "gui": "#F81CE5", "cterm": "200", "cterm16": "13" }
let s:visual_grey = { "gui": "#d0d0d0", "cterm": "252", "cterm16": "7" }
let s:menu_grey = { "gui": s:visual_grey.gui, "cterm": s:visual_grey.cterm, "cterm16": "8" }
let s:special_grey = { "gui": "#d0d0d0", "cterm": "252", "cterm16": "7" }
let s:vertsplit = { "gui": "#1c1c1c", "cterm": "234", "cterm16": "8" }
